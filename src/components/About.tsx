  ...
  public render(): JSX.Element{
    return(
      <div className="row">
        ...
        <div className="col-sm-6 col-md-4">
          <div className="thumbnail">
            <img src="https://vignette.wikia.nocookie.net/nintendo/images/d/d8/New_Super_Mario_Bros._U_Deluxe_-_Mario_01.png/revision/latest?cb=20181226204245&path-prefix=en" alt="..."/>
          </div>
          <div className="caption">
            <h3>Yunho Cho</h3>
            <p>Code Life</p>
